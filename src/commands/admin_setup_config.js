...
async function handleQuickSetup(interaction) {
    const selectMenu = new StringSelectMenuBuilder()
        ...
        .addOptions(
            { 
                label: 'Essential Channels (main channels)', 
                value: 'essential_channels', 
                description: 'Quick setup for core channel IDs',
                emoji: '📢'
            },
            { 
                label: 'Essential Roles (main roles)', 
                value: 'essential_roles', 
                description: 'Quick setup for core role IDs',
                emoji: '👥'
            },
            { 
    ...
    await interaction.reply({
        content: '**🚀 Quick Setup Wizard**\n\nChoose what you want to configure:\n\n**💡 Tip:** Essential options let you configure the main channel and role IDs at once!',
        components: [row],
        ephemeral: true
    });
}
