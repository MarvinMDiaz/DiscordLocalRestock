...
async function handleConfigChannelSelect(interaction) {
    ...
    const currentValue = channelKey.startsWith('restock') || channelKey.startsWith('local')
...
async function handleConfigChannelSubmit(interaction) {
    ...
    try {
        ...
        if (channelKey.startsWith('restock') || channelKey.startsWith('local')) {
...
async function handleQuickSetupSelect(interaction) {
    ...
    if (option === 'essential_channels') {
        // Show modal with core channel IDs
        const modal = new ModalBuilder()
...
async function handleEssentialChannelsSubmit(interaction) {
    ...
    try {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription('All essential channel IDs have been updated successfully.')
            .addFields(
...
async function handleEssentialRolesSubmit(interaction) {
    ...
    try {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription('All essential role IDs have been updated successfully.')
            .addFields(
